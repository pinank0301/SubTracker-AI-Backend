package com.subscription.auth.logging;
...
public class RequestResponseLoggingFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        log.info(">>> Incoming Request  | Method={} | URI={}", method, fullUri);
        ...
        try {
            ...
            if (statusCode >= 500) {
                log.error("<<< Outgoing Response | Method={} | URI={} | Status={} | Duration={}ms",
                        method, fullUri, statusCode, executionTime);
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
        String uri = request.getRequestURI();
        // Skip health check and swagger static assets to reduce noise
